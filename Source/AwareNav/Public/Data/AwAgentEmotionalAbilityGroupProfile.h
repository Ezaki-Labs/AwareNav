...
struct AWARENAV_API FEmotionalAbilityGroup
{
	...
	UPROPERTY(EditAnywhere, meta = (ClampMin = 1, ClampMax = 20, UIMin = 1, UIMax = 20), meta = (ToolTip = "Emotional resilience against fear. Higher value means less influence from fear zones."))
	int32 Courage = 10;
	...
	UPROPERTY(EditAnywhere, meta = (ClampMin = 1, ClampMax = 20, UIMin = 1, UIMax = 20), meta = (ToolTip = "Affinity for comfort and security. Higher value increases attraction to safe zones."))
	...
	UPROPERTY(EditAnywhere, meta = (ClampMin = 1, ClampMax = 20, UIMin = 1, UIMax = 20), meta = (ToolTip = "Emotional memory sensitivity. Affects how strongly the character responds to nostalgia and haunting zones."))
	int32 Memory = 10;	
};
