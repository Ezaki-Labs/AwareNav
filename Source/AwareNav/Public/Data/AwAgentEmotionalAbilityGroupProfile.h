...
#include "AwAgentEmotionalAbilityGroupProfile.generated.h"

USTRUCT(BlueprintType)
struct AWARENAV_API FEmotionalAbilityGroup
{
	GENERATED_BODY()
	...
	UPROPERTY(EditAnywhere, Category="AwareNav|Emotions", meta = (ClampMin = 1, ClampMax = 20, UIMin = 1, UIMax = 20), meta = (ToolTip = "Emotional resilience against fear. Higher value means less influence from fear zones."))
	int32 Courage = 10;
	...
	UPROPERTY(EditAnywhere, Category="AwareNav|Emotions", meta = (ClampMin = 1, ClampMax = 20, UIMin = 1, UIMax = 20), meta = (ToolTip = "Affinity for comfort and security. Higher value increases attraction to safe zones."))
	...
	UPROPERTY(EditAnywhere, Category="AwareNav|Emotions", meta = (ClampMin = 1, ClampMax = 20, UIMin = 1, UIMax = 20), meta = (ToolTip = "Emotional memory sensitivity. Affects how strongly the character responds to nostalgia and haunting zones."))
	int32 Memory = 10;	
};
...
struct AWARENAV_API FAwAgentEmotionalAbilityGroupProfile : public FTableRowBase
{
	...
	UPROPERTY(EditAnywhere, Category="AwareNav|Emotions", meta = (ToolTip = "The set of emotional abilities for this group profile."))
